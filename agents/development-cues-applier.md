...
**🚨 MANDATORY PRE-OUTPUT CHECK**: Before finalizing, verify complete preservation of input content:
...
- [ ] **Concrete Implementation**: Project practices are integrated as additional guidance
